  ...
  return (
      ...
      hover:rotate-[4deg] hover:translate-y-1 hover:scale-105 hover:shadow-xl">
        <div className="flex justify-between items-center ">
          <span className="text-sm font-sporting group-hover:bg-black  bg-[#C5FFEE]  rounded-full mb-5 text-black group-hover:text-white px-4">{action}</span>
        <div className="flex gap-2  items-center hover:underline"><IoMdArrowForward />
        <button > Read more</button>
         </div>
    </div>
      <p className="text-sm text-gray-300 group-hover:text-black font-sporting">{description}</p>
    </div>
